...
%farben für den text (listings definieren)
...
\begin{document}
	...
	\fancyhf{}
	\lhead{Team 1}
	\chead{\textbf{SWPt: Kundenprojekt II - Webtechnologien} \\ Dozentin: Prof. Dr. M\"uller-Birn}
	\rhead{SS 12 \\ \today}
	\cfoot{\tiny{Freie Universit\"at Berlin\\ Fachbereich Mathematik und Informatik\\ Institut f\"ur Informatik}}
	\rfoot{\smallskip \thepage}
	\renewcommand{\footrulewidth}{0.4pt} %untere Trennlinie

	%kopf und fußzeilen für alle seiten (auch inhalt und anhang)
	\fancypagestyle{plain}{
    \fancyhf{}
		\lhead{Team 1}
		\chead{\textbf{SWP: Kundenprojekt II - Webtechnologien} \\ Dozentin: Prof. Dr. M\"uller-Birn}
		\rhead{SS 12 \\ \today}
		\cfoot{\tiny{Freie Universit\"at Berlin\\ Fachbereich Mathematik und Informatik\\ Institut f\"ur Informatik}}
		\rfoot{\smallskip \thepage}
		\renewcommand{\footrulewidth}{0.4pt} %untere Trennlinie	
...
%	\addcontentsline{toc}{chapter}{Literaturverzeichnis}
	...
	%nicht-zitierte BibTeX-Einträge anzeigen
